...
- [x] Pass full suite: `PATH="$HOME:$PATH" HOST=http://localhost:3000 bash realworld/specs/api/run-api-tests-hurl.sh realworld/specs/api/hurl/*.hurl`
  - **Result**: 13/13 files, 149/149 requests ✅
